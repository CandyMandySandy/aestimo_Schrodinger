...
s0.material = [
            [ 10, 'AlGaAs', 0.28, 5e18, 'n'],
            [ 2.6, 'AlAs', 1, 0.0, 'n'],
            [ 2.5, 'GaAs', 0, 4e18, 'n'],
            [ 2.6, 'AlAs', 1, 0.0, 'n'], #barrier layer
            [ 2.5, 'GaAs', 0, 4e18, 'n'],       
            [ 2.6, 'AlAs', 1, 0.0, 'n'], #barrier layer
            [ 2.5, 'GaAs', 0, 4e18, 'n'],       
            [ 5, 'AlAs', 1, 2e18, 'n'],
...
gaas_layer = [3,5,7] # defines which layer will be adjusted later
alas_layer = [2,4,6] # defines which layer will be adjusted later
structure0 = s0
